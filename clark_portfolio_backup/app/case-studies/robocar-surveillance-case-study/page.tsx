    ...
    <>
      ...
      <main className="p-8 max-w-4xl mx-auto">
        ...
        <div className="w-full mb-2">
          <Image src="/images/Robocar.jpg" alt="RoboCar Hero" width={900} height={300} className="w-full h-auto rounded shadow-lg object-cover" />
        </div>
        ...
        <div className="flex gap-4 mb-4">
          ...
          <a href="https://github.com/jorodotexe/robocar" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/robocar_IPO1.jpg" alt="IPO Model Diagram 1" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/robocar_IPO2.jpg" alt="IPO Model Diagram 2" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/robocar_bluedot.jpg" alt="System Flowchart 1" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/robocar_web.jpg" alt="System Flowchart 2" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 my-4">
            <Image src="/images/robocar_prototype.jpg" alt="RoboCar Prototype 1" width={400} height={200} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/robocar_actual.jpg" alt="RoboCar Prototype 2" width={400} height={200} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="flex justify-center my-4">
            <Image src="/images/robocar_interface.jpg" alt="Web Dashboard" width={1000} height={600} className="rounded shadow bg-black w-full h-auto max-w-[1000px]" />
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 text-gray-300 mb-2">
            ...
            <li>Provided a cost-effective alternative to static monitors (total cost: ~$200).</li>
          </ul>
