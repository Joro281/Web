    ...
    <>
      ...
      <main className="p-8 max-w-4xl mx-auto">
        ...
        <div className="w-full mb-2">
          <Image src="/images/portfolio.jpg" alt="Portfolio Development Hero" width={900} height={300} className="w-full h-auto rounded shadow-lg object-cover" />
        </div>
        {/* Figma, Folder, and GitHub Lucide Icons, left-aligned */}
        <div className="flex gap-4 mb-4">
          <a href="https://github.com/jorodotexe/portfolio" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
