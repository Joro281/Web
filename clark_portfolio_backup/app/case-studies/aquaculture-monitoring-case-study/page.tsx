    ...
    <>
      ...
      <main className="p-8 max-w-4xl mx-auto">
        ...
        <div className="w-full mb-2">
          <Image src="/images/Thesis.jpg" alt="Aquaculture System Hero" width={900} height={300} className="w-full h-auto rounded shadow-lg object-cover" />
        </div>
        {/* Folder and GitHub Lucide Icons, left-aligned */}
        <div className="flex gap-4 mb-4">
          ...
          <a href="https://github.com/jorodotexe/aquaculture-system" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/aquaclear_IPO.jpg" alt="System Architecture 1" width={600} height={300} className="rounded shadow bg-black w-full h-auto max-w-[600px]" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/aquaclear_UI.jpg" alt="Web Interface 1" width={500} height={400} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/aquaclear_database.jpg" alt="Web Interface 2" width={500} height={400} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/aquaclear_system.jpg" alt="Algae Chamber Setup 1" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/aquaclear_brainboard.jpg" alt="Algae Chamber Setup 2" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 text-gray-300 mb-2">
            <li>Float Switch Failures: Algae buildup disrupted sensor accuracy.</li>
            <li>Power Dependency: Required stable electricity for continuous operation.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 text-gray-300 mb-2">
            <li>The system successfully automated pH stabilization (7.4–7.6) using Chlorella vulgaris.</li>
          ...
          <ul className="list-disc ml-6 text-gray-300 mb-2">
            <li>Expand Sensors: Add ammonia/nitrite detectors for comprehensive water quality monitoring.</li>
            <li>Solar Power: Integrate renewable energy for off-grid use.</li>
            <li>Anti-Fouling Measures: Modify float switches to resist algae buildup.</li>
            <li>Commercial Scaling: Test larger chambers for commercial aquaculture.</li>
          </ul>
        </section>
      </main>
      <SlideUpFooter />
