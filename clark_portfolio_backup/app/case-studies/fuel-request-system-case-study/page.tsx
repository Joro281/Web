    ...
    <>
      ...
      <main className="p-8 max-w-4xl mx-auto">
        ...
        <div className="w-full mb-2">
          <Image src="/images/Fuel_Request.jpg" alt="Fuel Request System Hero" width={900} height={300} className="w-full h-auto rounded shadow-lg object-cover" />
        </div>
        {/* Figma, Folder, and GitHub Lucide Icons, left-aligned */}
        <div className="flex gap-4 mb-4">
          <a href="https://www.figma.com/design/SdAJN2bBluX5Xqlk5ga0XE/Fuel-Request-System?node-id=0-1&t=qcUoPEVOfuhm6CtX-1" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
          ...
          <a href="https://github.com/jorodotexe/fuel-request-system" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
        ...
        <section className="mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/Fuel_Request.jpg" alt="System Workflow Diagram" width={400} height={200} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/fuelrequest_user.jpg" alt="System Workflow Diagram" width={400} height={200} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
