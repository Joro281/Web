    ...
    <>
      ...
      <main className="p-8 max-w-4xl mx-auto">
        ...
        <div className="w-full mb-2">
          <Image src="/images/birddetection_hero.jpg" alt="Bird Detection System Hero" width={900} height={300} className="w-full h-auto rounded shadow-lg object-cover" />
        </div>
        ...
        <div className="flex gap-4 mb-4">
          ...
          <a href="https://github.com/jorodotexe/bird-detection-system" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform text-green-400 hover:text-green-300">
        ...
        <section className="mb-8">
          ...
          <div className="flex justify-center my-4">
            <Image src="/images/birddetection_conceptual.jpg" alt="Conceptual Framework Diagram" width={600} height={400} className="rounded shadow bg-black w-full h-auto max-w-[600px]" />
          </div>
          ...
          <div className="flex justify-center my-4">
            <Image src="/images/birddetection_wiring.jpg" alt="Wiring Diagram" width={600} height={400} className="rounded shadow bg-black w-full h-auto max-w-[600px]" />
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 my-4">
            <Image src="/images/birddetection_prototype.jpg" alt="Prototype Setup 1" width={200} height={100} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/birddetection_brainboard.jpg" alt="Prototype Setup 2" width={400} height={200} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 my-4">
            <Image src="/images/birddetection_blynk.png" alt="Realtime Database 1" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
            <Image src="/images/birddetection_firebase.jpg" alt="Realtime Database 2" width={400} height={300} className="rounded shadow bg-black w-full h-auto max-w-[400px]" />
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 text-gray-300 mb-2">
            ...
            <li>Provided a scalable, cost-effective solution (total cost: ₱1,809).</li>
          </ul>
